...
$db       = 'colinoco_aepi';     // Name of the database
$port     = '3306';                           // Port is usually 3306 in Hostgator
$charset  = 'utf8mb4';                       // UTF-8 encoding using 4 bytes of data per char

$username = 'colinoco_colinoconnor9';     // Enter YOUR cPanel username and user here
$password = 'GiBlC6s9TITtOB6IoAE';         // Enter YOUR user password here                                     
